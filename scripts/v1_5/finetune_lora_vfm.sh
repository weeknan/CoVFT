...
CUDA_VISIBLE_DEVICES=0,1 deepspeed --master_port 29679 --num_gpus 2 llava/train/train_mem.py \
    --vfm_tuning_type lora \
    --vfm_lora_r 8 \
    --vfm_lora_alpha 16 \
    --vfm_lora_dropout 0.05 \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b_lora_vfm \
    --num_train_epochs 1 \
