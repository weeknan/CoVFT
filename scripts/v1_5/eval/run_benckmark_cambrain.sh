...
benchmark_dir="./playground/data/eval/${benchmark}"
...
answers_file="./${benchmark_dir}/answers/answers_${model_basename}.jsonl"
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    idx_file=./${benchmark_dir}/answers/answers_${model_basename}_${IDX}.jsonl
