...
CUDA_VISIBLE_DEVICES=0,1 deepspeed --master_port 29671 --num_gpus 2 llava/train/train_mem.py \
    --vfm_tuning_type fullft \
    ...
    --bf16 True \
    --output_dir ./checkpoints/llava-v1.5-7b_fullft_vfm \
    --num_train_epochs 1 \
